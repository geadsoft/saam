...
var T_check = null;
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function (info) {
            ...
            var d = new Date(st_date);
            st_date = d.setDate(d.getDate() + 1);
            ...
            document.getElementById("event-start-date").value = date_r(st_date);

            if (ed_date == null){
                document.getElementById("event-end-date-tag").innerHTML = str_dt(st_date);
                document.getElementById("event-end-date").value = date_r(st_date);
            }else{
                document.getElementById("event-end-date-tag").innerHTML = str_dt(ed_date);
                document.getElementById("event-end-date").value = date_r(ed_date);
            }
...
function eventClicked() {
    ...
    document.getElementById('long-modal').classList.remove("modal-xl");
    ...
    document.getElementById("event-end-date").parentNode.classList.add("d-none");
    document.getElementById("event-end-date").classList.replace("d-block", "d-none");
    document.getElementById('detail-col2').setAttribute("hidden", true);
    ...
    document.getElementById("event-start-date-tag").classList.replace("d-none", "d-block");
    document.getElementById("event-end-date-tag").classList.replace("d-none", "d-block");
    document.getElementById("event-description-tag").classList.replace("d-none", "d-block");
    document.getElementById("detail-col1").classList.replace("col-xl-6", "col-xl-12");
    document.getElementById('btn-save-event').setAttribute("hidden", true);
...
function editEvent(data) {
    ...
    if (data_id == 'new-event') {
        ...
        document.getElementById("btn-save-event").innerHTML = "Grabar";
        eventTyped();
...
function eventTyped() {
    ...
    document.getElementById('long-modal').classList.add("modal-xl");
    ...
    document.getElementById("event-end-date").parentNode.classList.remove("d-none");
    document.getElementById("event-end-date").classList.replace("d-none", "d-block");
    /*document.getElementById("timepicker1").parentNode.classList.remove("d-none");
    document.getElementById("timepicker1").classList.replace("d-none", "d-block");
    document.getElementById("timepicker2").parentNode.classList.remove("d-none");
    document.getElementById("timepicker2").classList.replace("d-none", "d-block");
    ...
    document.getElementById("event-end-date-tag").classList.replace("d-block", "d-none");
