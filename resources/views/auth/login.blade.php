                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="{{ URL::asset('assets/images/sams.png')}}" alt="" height="50">
                            </a>
                        </div>
                        <p class="mt-3 fs-15 fw-medium">Gestión Contable y Administrativa</p>
                    </div>
                </div>
            </div>
            <!-- end row -->
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card mt-4">
                        <div class="text-center mt-sm-3">
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="{{ URL::asset('assets/images/quevepalma.png')}}" alt="" height="150">
                            </a>
                        </div>
                        <div class="card-body p-4">
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="usrname" class="form-label">Usuario</label>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy; <script>document.write(new Date().getFullYear())</script> SAAM. Elaborado </i> por GSD</p>
                    </div>
                </div>
            </div>
        </div>
