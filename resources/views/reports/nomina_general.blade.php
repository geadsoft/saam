...
<body>
    ...
    <section style ="margin-top: -110px;">
        <table class="table table-sm align-middle" cellpadding="0" cellspacing="0" style="font-size:8px"  width="100%">
            <thead class="table-light">
                <tr>
                    <th class="text-left" style="width: 30px;">Código</th>
                    <th class="text-left" style="width: 180px;">Empleados</th>
                    <th class="text-left" style="width: 60px;">Cédula</th>
                    @foreach ($etiqueta as $index => $head)
                        @if($index<=10)
                        <th class="text-right" style="width: 50px;">{{$head['etiqueta']}}</th>
                        @endif
                    @endforeach
                </tr>
                <tr>
                    ...
                    @foreach ($etiqueta as $index => $head)
                        @if($index>10)
                        <th class="text-right" style="width: 60px;">{{$head['etiqueta']}}</th>
                        @endif
                    @endforeach
                </tr>
            <thead>
            ...
            <tfoot>
                <tr>
                    ...
                    @foreach ($etiqueta as $index => $head)
                        @if($index<=10)
                        <td class="text-right"><strong>{{number_format($totales[0][$head['codigo']],2)}}</strong></td>
                        @endif
                    @endforeach 
                </tr>
                <tr>
