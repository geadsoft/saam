<div>
                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="hstack text-nowrap gap-2">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item" target="_blank" href="/download-pdf/pagorol/{{$datos}}"><i class="ri-stack-line align-bottom me-2 text-muted"></i> Comprobante de Pago </a></li>
                                </ul>
                                @endif
                                <!--<button type="button" data-bs-toggle="dropdown" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li><a class="dropdown-item" href="/nomina/view-rubros/{{$rolpagoId}}"><i class="ri-article-line align-bottom me-2 text-muted"></i> Rubros Nomina </a></li>
    ...
    <div wire.ignore.self class="modal fade flip" id="viewRubros" tabindex="-1" aria-hidden="true" wire:model='selectId'>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body">
                    <div class="mt-4">
                        <table class="table table-sm align-middle" style="width:100%">
                            <thead class="table-light">
                                <tr>
                                    <th scope="col" style="width: 320px;" class="text-center">Rubro</th>
                                    <th scope="col" style="width: 200px;" class="text-center">Monto</th>
                                </tr>
                            </thead>
                            <tbody class="list form-check-all">
                                @foreach ($rubrototal as $rtotal)
                                   
                                    <tr class="detalle">
                                        <td>{{$rtotal->rubrosrol['descripcion']}}</td>
                                        <td class="text-end"> $ {{number_format($rtotal->monto,2)}}</td>
                                    </tr>
