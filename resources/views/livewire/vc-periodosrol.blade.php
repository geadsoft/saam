                                ...
                                <form autocomplete="off" wire:submit.prevent="{{ $showEditModal ? 'updateData' : 'createData' }}">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <input id="dfechaini" name="dateIni" type="date" class="form-control" data-provider="flatpickr" data-date-format="d-m-Y" data-time="true"  wire:model.defer="record.fechaini" required disabled>
                                            </div>
                                            <br>
                                            <div>
                                                <input id="dfechafin" name="dateFin" type="date" class="form-control" data-provider="flatpickr" data-date-format="d-m-Y" data-time="true"  wire:model.defer="record.fechafin" required disabled>
                                            </div>
                                        </div>
                                    </div>
